...
public abstract class MicroService implements Runnable {
    private static MessageBus messageBus=MessageBusImpl.getInstance();
    private  HashMap<Class,Callback> messageCallbackHashMap;
    ...
    public MicroService(String name) {
        this.name = name;
        messageCallbackHashMap=new HashMap<>();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
            ...
            messageCallbackHashMap.put(type, callback);
       ...
       messageBus.register(this);
        ...
        while (!terminated) {
            try {
                ...
                Callback callback = messageCallbackHashMap.get(message.getClass());
